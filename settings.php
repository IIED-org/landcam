...
if (file_exists('/var/www/site-php')) {
  require '/var/www/site-php/landcam/landcam-settings.inc';
}
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_devcloud_landcam_dev_landcam.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_devcloud_landcam_dev_landcam.inc';
}
// </DDSETTINGS>
